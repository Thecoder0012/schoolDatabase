    ...
    public void run() throws SQLException {
        ...
        menuList();
            switch(userInput.nextInt()){
                ...
                case 2 -> addToTable(statement);
                case 3 -> viewTableNames(connection);
                case 4 -> viewTableContent(statement);
                case 5 -> updateRecord(statement);
                case 6 -> deleteRecord(statement);
                case 7 -> exitConnection(statement,connection);
                default -> {
                    if(running){
